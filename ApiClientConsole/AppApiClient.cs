...
namespace ApiClient
{
    ...
    public partial class DataCreditClient 
    {
        private string _baseUrl = "";
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public DataCreditClient(string baseUrl)
        {
            BaseUrl = baseUrl;
        ...
        {
            return GetOutputCreditDetailsAsync(inputDataCredit, System.Threading.CancellationToken.None);
        }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<IOutputDataCredit>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public abstract partial class IOutputDataCredit 
    {
        ...
        public ICollection<IPaymentDetails> PaymentDetails { get; set; }
    
        [Newtonsoft.Json.JsonProperty("overPayment", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.11.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class InputDataCredit 
    {
        [Newtonsoft.Json.JsonProperty("sumOfCredit", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Range(1.0D, 10000000000.0D)]
        public decimal SumOfCredit { get; set; }
    
        [Newtonsoft.Json.JsonProperty("creditTerm", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Range(1, 100000)]
        public int CreditTerm { get; set; }
    
        [Newtonsoft.Json.JsonProperty("interestRateOfYear", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Range(0.1D, 100.0D)]
